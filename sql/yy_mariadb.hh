...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    HOSTS_SYM = 734,               /* HOSTS_SYM  */
    HOUR_SYM = 735,                /* HOUR_SYM  */
    ID_SYM = 736,                  /* ID_SYM  */
    IDENTIFIED_SYM = 737,          /* IDENTIFIED_SYM  */
    IGNORE_SERVER_IDS_SYM = 738,   /* IGNORE_SERVER_IDS_SYM  */
    IMMEDIATE_SYM = 739,           /* IMMEDIATE_SYM  */
    IMPORT = 740,                  /* IMPORT  */
    INCREMENT_SYM = 741,           /* INCREMENT_SYM  */
    INDEXES = 742,                 /* INDEXES  */
    INITIAL_SIZE_SYM = 743,        /* INITIAL_SIZE_SYM  */
    ...
    LOGFILE_SYM = 766,             /* LOGFILE_SYM  */
    LOGS_SYM = 767,                /* LOGS_SYM  */
    LOG_SYM = 768,                 /* LOG_SYM  */
    ...
    PACK_KEYS_SYM = 844,           /* PACK_KEYS_SYM  */
    PAGE_SYM = 845,                /* PAGE_SYM  */
    PARSER_SYM = 846,              /* PARSER_SYM  */
    PARTIAL = 847,                 /* PARTIAL  */
    PARTITIONS_SYM = 848,          /* PARTITIONS_SYM  */
    PARTITIONING_SYM = 849,        /* PARTITIONING_SYM  */
    PASSWORD_SYM = 850,            /* PASSWORD_SYM  */
    PERIOD_SYM = 851,              /* PERIOD_SYM  */
    PERSISTENT_SYM = 852,          /* PERSISTENT_SYM  */
    PHASE_SYM = 853,               /* PHASE_SYM  */
    PLUGINS_SYM = 854,             /* PLUGINS_SYM  */
    PLUGIN_SYM = 855,              /* PLUGIN_SYM  */
    PORT_SYM = 856,                /* PORT_SYM  */
    PRECEDES_SYM = 857,            /* PRECEDES_SYM  */
    PRECEDING_SYM = 858,           /* PRECEDING_SYM  */
    PREPARE_SYM = 859,             /* PREPARE_SYM  */
    PRESERVE_SYM = 860,            /* PRESERVE_SYM  */
    PREV_SYM = 861,                /* PREV_SYM  */
    PREVIOUS_SYM = 862,            /* PREVIOUS_SYM  */
    PRIVILEGES = 863,              /* PRIVILEGES  */
    PROCESS = 864,                 /* PROCESS  */
    PROCESSLIST_SYM = 865,         /* PROCESSLIST_SYM  */
    PROFILE_SYM = 866,             /* PROFILE_SYM  */
    PROFILES_SYM = 867,            /* PROFILES_SYM  */
    PROXY_SYM = 868,               /* PROXY_SYM  */
    QUARTER_SYM = 869,             /* QUARTER_SYM  */
    QUERY_SYM = 870,               /* QUERY_SYM  */
    QUICK = 871,                   /* QUICK  */
    RAW_MARIADB_SYM = 872,         /* RAW_MARIADB_SYM  */
    RAW_ORACLE_SYM = 873,          /* RAW_ORACLE_SYM  */
    READ_ONLY_SYM = 874,           /* READ_ONLY_SYM  */
    REBUILD_SYM = 875,             /* REBUILD_SYM  */
    RECOVER_SYM = 876,             /* RECOVER_SYM  */
    REDOFILE_SYM = 877,            /* REDOFILE_SYM  */
    REDO_BUFFER_SIZE_SYM = 878,    /* REDO_BUFFER_SIZE_SYM  */
    REDUNDANT_SYM = 879,           /* REDUNDANT_SYM  */
    RELAY = 880,                   /* RELAY  */
    RELAYLOG_SYM = 881,            /* RELAYLOG_SYM  */
    RELAY_LOG_FILE_SYM = 882,      /* RELAY_LOG_FILE_SYM  */
    RELAY_LOG_POS_SYM = 883,       /* RELAY_LOG_POS_SYM  */
    RELAY_THREAD = 884,            /* RELAY_THREAD  */
    RELOAD = 885,                  /* RELOAD  */
    REMOVE_SYM = 886,              /* REMOVE_SYM  */
    REORGANIZE_SYM = 887,          /* REORGANIZE_SYM  */
    REPAIR = 888,                  /* REPAIR  */
    REPEATABLE_SYM = 889,          /* REPEATABLE_SYM  */
    REPLAY_SYM = 890,              /* REPLAY_SYM  */
    REPLICATION = 891,             /* REPLICATION  */
    RESET_SYM = 892,               /* RESET_SYM  */
    RESTART_SYM = 893,             /* RESTART_SYM  */
    RESOURCES = 894,               /* RESOURCES  */
    RESTORE_SYM = 895,             /* RESTORE_SYM  */
    RESUME_SYM = 896,              /* RESUME_SYM  */
    RETURNED_SQLSTATE_SYM = 897,   /* RETURNED_SQLSTATE_SYM  */
    RETURNS_SYM = 898,             /* RETURNS_SYM  */
    REUSE_SYM = 899,               /* REUSE_SYM  */
    REVERSE_SYM = 900,             /* REVERSE_SYM  */
    ROLE_SYM = 901,                /* ROLE_SYM  */
    ROLLBACK_SYM = 902,            /* ROLLBACK_SYM  */
    ROLLUP_SYM = 903,              /* ROLLUP_SYM  */
    ROUTINE_SYM = 904,             /* ROUTINE_SYM  */
    ROWCOUNT_SYM = 905,            /* ROWCOUNT_SYM  */
    ROW_SYM = 906,                 /* ROW_SYM  */
    ROW_COUNT_SYM = 907,           /* ROW_COUNT_SYM  */
    ROW_FORMAT_SYM = 908,          /* ROW_FORMAT_SYM  */
    RTREE_SYM = 909,               /* RTREE_SYM  */
    SAVEPOINT_SYM = 910,           /* SAVEPOINT_SYM  */
    SCHEDULE_SYM = 911,            /* SCHEDULE_SYM  */
    SCHEMA_NAME_SYM = 912,         /* SCHEMA_NAME_SYM  */
    SECOND_SYM = 913,              /* SECOND_SYM  */
    SECURITY_SYM = 914,            /* SECURITY_SYM  */
    SEQUENCE_SYM = 915,            /* SEQUENCE_SYM  */
    SERIALIZABLE_SYM = 916,        /* SERIALIZABLE_SYM  */
    SERIAL_SYM = 917,              /* SERIAL_SYM  */
    SESSION_SYM = 918,             /* SESSION_SYM  */
    SESSION_USER_SYM = 919,        /* SESSION_USER_SYM  */
    SERVER_SYM = 920,              /* SERVER_SYM  */
    SETVAL_SYM = 921,              /* SETVAL_SYM  */
    SHARE_SYM = 922,               /* SHARE_SYM  */
    SHUTDOWN = 923,                /* SHUTDOWN  */
    SIGNED_SYM = 924,              /* SIGNED_SYM  */
    SIMPLE_SYM = 925,              /* SIMPLE_SYM  */
    SKIP_SYM = 926,                /* SKIP_SYM  */
    SLAVE = 927,                   /* SLAVE  */
    SLAVES = 928,                  /* SLAVES  */
    SLAVE_POS_SYM = 929,           /* SLAVE_POS_SYM  */
    SLOW = 930,                    /* SLOW  */
    SNAPSHOT_SYM = 931,            /* SNAPSHOT_SYM  */
    SOFT_SYM = 932,                /* SOFT_SYM  */
    SONAME_SYM = 933,              /* SONAME_SYM  */
    SOUNDS_SYM = 934,              /* SOUNDS_SYM  */
    SOURCE_SYM = 935,              /* SOURCE_SYM  */
    SQL_AFTER_GTIDS_SYM = 936,     /* SQL_AFTER_GTIDS_SYM  */
    SQL_BEFORE_GTIDS_SYM = 937,    /* SQL_BEFORE_GTIDS_SYM  */
    ...
    TYPE_SYM = 982,                /* TYPE_SYM  */
    UDF_RETURNS_SYM = 983,         /* UDF_RETURNS_SYM  */
    UNBOUNDED_SYM = 984,           /* UNBOUNDED_SYM  */
    UNCOMMITTED_SYM = 985,         /* UNCOMMITTED_SYM  */
    UNDEFINED_SYM = 986,           /* UNDEFINED_SYM  */
    UNDOFILE_SYM = 987,            /* UNDOFILE_SYM  */
    UNDO_BUFFER_SIZE_SYM = 988,    /* UNDO_BUFFER_SIZE_SYM  */
    UNICODE_SYM = 989,             /* UNICODE_SYM  */
    UNINSTALL_SYM = 990,           /* UNINSTALL_SYM  */
    UNKNOWN_SYM = 991,             /* UNKNOWN_SYM  */
    UNTIL_SYM = 992,               /* UNTIL_SYM  */
    UPGRADE_SYM = 993,             /* UPGRADE_SYM  */
    USER_SYM = 994,                /* USER_SYM  */
    USE_FRM = 995,                 /* USE_FRM  */
    VALIDATION_SYM = 996,          /* VALIDATION_SYM  */
    ...
    USER = 1025,                   /* USER  */
    PREC_BELOW_SP_OBJECT_TYPE = 1026, /* PREC_BELOW_SP_OBJECT_TYPE  */
    PREC_BELOW_CONTRACTION_TOKEN2 = 1027, /* PREC_BELOW_CONTRACTION_TOKEN2  */
    EMPTY_FROM_CLAUSE = 1028       /* EMPTY_FROM_CLAUSE  */
  };
...
#line 989 "/home/buildbot/tarball-docker/build/mkdist/sql/yy_mariadb.hh"
